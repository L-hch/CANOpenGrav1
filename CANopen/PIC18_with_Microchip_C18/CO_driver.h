...
//      #define PCB_RUN_LED(i)        PORTBbits.RB4 = i
      #define PCB_RUN_LED_INIT()    {TRISBbits.TRISB4 = 0; LATBbits.LATB4 = 0;}
      #define PCB_RUN_LED(i)        LATBbits.LATB4 = i
      //Red ERROR led
//      #define PCB_ERROR_LED_INIT()  {TRISBbits.TRISB5 = 0; PORTBbits.RB5 = 0;}
//      #define PCB_ERROR_LED(i)      PORTBbits.RB5 = i
      #define PCB_ERROR_LED_INIT()    {TRISBbits.TRISB5 = 0; LATBbits.LATB5 = 0;}
      #define PCB_ERROR_LED(i)        LATBbits.LATB5 = i
