...
#include "mpu6050.h"
 ...
 extern unsigned short Timersec;
...
ROM UNSIGNED8 N_ENTRY_2=2;
ROM UNSIGNED8 N_ENTRY_3=3;
ROM UNSIGNED8 N_ENTRY_4=4;
ROM UNSIGNED8 N_ENTRY_5=5;
ROM UNSIGNED8 N_ENTRY_6=6;
ROM UNSIGNED8 N_ENTRY_7=7;
ROM UNSIGNED8 N_ENTRY_8=8;
...
#ifdef CANnodeID_ON_SWITCH
   OD_ENTRY(0x2101, 0x00, ATTR_RO, ODE_CANnodeID),
#else
...
/*******  I/O specific info  ***********************************/
  ...
  OD_ENTRY(0x6000,0x00, ATTR_RW, ODE_EEPROM.MPU6050_control.value), // Accelerometer control 
 
  OD_ENTRY(0x6001,0x00,ATTR_RO|ATTR_ROM,N_ENTRY_8),  // accelerometer1 MPU6050
  OD_ENTRY(0x6001,0x01,ATTR_RO, MPU6050_device1Data.Valid),    //  is it enabled
  OD_ENTRY(0x6001,0x02,ATTR_RO, MPU6050_device1Data.AccX),
  OD_ENTRY(0x6001,0x03,ATTR_RO, MPU6050_device1Data.AccY),
  OD_ENTRY(0x6001,0x04,ATTR_RO, MPU6050_device1Data.AccZ),
  OD_ENTRY(0x6001,0x05,ATTR_RO, MPU6050_device1Data.Temp),
  OD_ENTRY(0x6001,0x06,ATTR_RO, MPU6050_device1Data.GyroX),
  OD_ENTRY(0x6001,0x07,ATTR_RO, MPU6050_device1Data.GyroY),
  OD_ENTRY(0x6001,0x08,ATTR_RO, MPU6050_device1Data.GyroZ),

  OD_ENTRY(0x6002,0x00,ATTR_RO|ATTR_ROM,N_ENTRY_8),  // accelerometer2 MPU6050
  OD_ENTRY(0x6002,0x01,ATTR_RO, MPU6050_device2Data.Valid),    //  is it enabled
  OD_ENTRY(0x6002,0x02,ATTR_RO, MPU6050_device2Data.AccX),
  OD_ENTRY(0x6002,0x03,ATTR_RO, MPU6050_device2Data.AccY),
  OD_ENTRY(0x6002,0x04,ATTR_RO, MPU6050_device2Data.AccZ),
  OD_ENTRY(0x6002,0x05,ATTR_RO, MPU6050_device2Data.Temp),
  OD_ENTRY(0x6002,0x06,ATTR_RO, MPU6050_device2Data.GyroX),
  OD_ENTRY(0x6002,0x07,ATTR_RO, MPU6050_device2Data.GyroY),
  OD_ENTRY(0x6002,0x08,ATTR_RO, MPU6050_device2Data.GyroZ)
};
