...
*******************************************************************************/
   ...
   #define CO_NO_RPDO            1  //(0 to 512*), number of receive PDOs.
...
*******************************************************************************/
   ...
   #define ODD_MANUF_DEVICE_NAME "CANopenNode"  /*index 0x1008, RO*/
...
/* 0x1600 Receive PDO mapping *************************************************/
   ...
   #define ODD_RPDO_MAP_0_1      0x60000008L
...
// ok just send the timersec (16 bits) on default TPDO 0 (0x180 + Node Id)
// Acclerometer 1 Acc. Values
   #define ODD_TPDO_MAP_0_1      0x60010210L       // accelerometer1  AccX
   #define ODD_TPDO_MAP_0_2      0x60010310L       // AccY
   #define ODD_TPDO_MAP_0_3      0x60010410L       // AccZ
...
// Acclerometer 1 Gyros Values
   #define ODD_TPDO_MAP_1_1      0x60010610L    // Accelerometer1 GyrosX
   #define ODD_TPDO_MAP_1_2      0x60010710L   // Gyro Y
   #define ODD_TPDO_MAP_1_3      0x60010810L   // Gyro Z
...
// Acclerometer 2 Acc. Values
   #define ODD_TPDO_MAP_2_1      0x60020210L       // accelerometer2  AccX
   #define ODD_TPDO_MAP_2_2      0x60020310L       // AccY
   #define ODD_TPDO_MAP_2_3      0x60020410L       // AccZ
...
// Acclerometer 2 Gyros Values
   #define ODD_TPDO_MAP_3_1      0x60020610L    // Accelerometer2 GyrosX
   #define ODD_TPDO_MAP_3_2      0x60020710L   // Gyro Y
   #define ODD_TPDO_MAP_3_3      0x60020810L   // Gyro Z
...
/*0x2101*/
   ...
   // CANnodeId is defined by DIP switch and will be offset by ODD_CANnodeID check user.c
   // The real CANnodeID will be ODD_CANnodeID + DIP switches readout
#endif
...
#ifdef CANnodeID_ON_SWITCH
/*0x2101*/ extern UNSIGNED8 ODE_CANnodeID;
#else
/*0x2101*/ extern ROM UNSIGNED8      ODE_CANnodeID = ODD_CANnodeID;
#endif
...
/*0x6000*/     MPU6050_controlUnion MPU6050_control;
