...
#define I2CREAD	    0x01		/* read bit used with address */
#define I2CWRITE	0x00		/* write bit used with address */
...
// i2c_Reset -  Try to Unlock i2c devices by pulsing 9 clocks on SCL when SDA is tri-state
void i2c_Reset(void);
